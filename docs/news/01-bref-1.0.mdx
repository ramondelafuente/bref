export const subTitle = 'Celebrating 1 billion executions per month';
export const layout = 'news-article';
export const articleDate = 'November 2020';
export const author = 'Matthieu Napoli';
export const authorGithub = 'mnapoli';
...
This is now documented in the [**Typed PHP Lambda handlers**](/docs/function/handlers.mdx) page.
...
Read more in the documentation: [Local development for functions](/docs/function/local-development.mdx).
...
Instead, you can deploy the same Lambda with both v1 and v2, [set up your domain on v2](/docs/environment/custom-domains.mdx), and then delete v1:
