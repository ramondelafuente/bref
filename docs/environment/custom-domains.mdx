export const description = 'Configure custom domain names for your web applications.';
...
Some applications serve static files hosted on AWS S3. You can read the [Websites](/docs/websites.mdx) documentation to learn more.
