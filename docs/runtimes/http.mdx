export const description = 'Learn how to run serverless HTTP applications with PHP on AWS Lambda using Bref.';
...
Deploying a website and serving assets (e.g. CSS, JavaScript, images) is covered in [the "Website assets" documentation](/docs/websites.mdx).
