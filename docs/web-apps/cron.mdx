export const description = 'Learn how to create CLI serverless cron tasks with PHP on AWS Lambda.';

# CLI cron tasks on AWS Lambda

AWS Lambda lets us run [console commands](/docs/runtimes/console.mdx) as cron tasks using the `schedule` event:
