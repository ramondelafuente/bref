...
- Your Lambda Function is [larger than 250MB when unzipped](../environment/storage.mdx)
- You reached the limit of 5 Lambda layers (e.g. for extra PHP extensions)
- You need resources installed locally (e.g. mysqldump)

> Note: this documentation page assumes that you have read about [web apps on Lambda](../runtimes/http.mdx) first.
